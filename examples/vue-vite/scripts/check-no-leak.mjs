#!/usr/bin/env node
// Layer-1 dev-only guard regression check for examples/vue-vite.
...
// devtools-widget identifier and is excluded to avoid false positives in
// adapters that happen to coexist with React on the same host page.
