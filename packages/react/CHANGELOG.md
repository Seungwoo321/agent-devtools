...
- [`19b1d2b`](https://github.com/Seungwoo321/agent-devtools/commit/19b1d2bb438c522f0135f17b3ab5eb671002a020) Thanks [@Seungwoo321](https://github.com/Seungwoo321)! - Add a third independent source-extraction channel so picker source
  locations survive future React-internal debug-metadata churn. React 18
  → 19 silently dropped `_debugSource` and replaced it with `_debugStack`;
  any future major could repeat the pattern. `resolveFiberSource` now
  tries, in order:
