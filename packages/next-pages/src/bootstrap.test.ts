...
describe('bootstrapAgentDevtools', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.AGENT_DEVTOOLS_NEXT_PAGES_ENABLED;
    delete process.env.AGENT_DEVTOOLS_NEXT_PAGES_BASE_URL;
    delete process.env.AGENT_DEVTOOLS_NEXT_PAGES_PAIRING_TOKEN;
  });
  ...
  it('mounts the widget when the env flag, base URL, and token are present in dev', async () => {
    ...
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_ENABLED = 'true';
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_BASE_URL = 'http://127.0.0.1:4317';
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_PAIRING_TOKEN = 'tok-1';
  ...
  it('prefers caller-provided overrides over env variables', async () => {
    ...
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_ENABLED = 'true';
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_BASE_URL = 'http://127.0.0.1:4317';
    process.env.AGENT_DEVTOOLS_NEXT_PAGES_PAIRING_TOKEN = 'env-token';
